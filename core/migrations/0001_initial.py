# Generated by Django 5.0.1 on 2024-03-24 03:34
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('chr', 'Chrysanthemum'), ('rs', 'Rose'), ('dh', 'Dalhi'), ('sf', 'Sunflower'), ('mg', 'Marigold'), ('pp', 'Poppy'), ('mb', 'Mix Bunch'), ('ll', 'Lily')], max_length=3)),
                ('label', models.CharField(choices=[('lchr', 'LG chrysan'), ('lrs', 'LG Rose'), ('ldh', 'LG Dalhi'), ('lsf', 'LG Sunflower'), ('lmg', 'LG Marigold'), ('lpp', 'LG Poppy'), ('lmb', 'LG Mix Bunch'), ('lil', 'LG Lily')], max_length=4)),
